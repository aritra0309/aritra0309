...
I'm a passionate **Machine Learning & AI Engineer** with a strong interest in **Data Science**, **Big Data**, and **Generative AI**. I love building intelligent systems that extract meaningful insights from data and solve real-world problems.

- 🔭 Currently working on **AI-powered tools** and **portfolio optimization**
- 🌱 Exploring **Large Language Models**, **Generative AI**, and **Big Data** pipelines
- 💡 Interested in **quantitative finance**, **computer vision**, and **NLP**
- 🛠️ Building with **Python**, **Hadoop**, and cutting-edge **ML frameworks**
- ⚡ Fun fact: I automated my GitHub maintenance with a bot!
...
|---------|-------------|------|
| [📈 Nifty 50 Portfolio Optimizer](https://github.com/aritra0309/nifty50-portfolio-optimizer) | Optimizes stock portfolios using Nifty 50 market data with advanced quantitative strategies | Python, pandas, scipy |
| [🔍 Hadoop Crime Project](https://github.com/aritra0309/hadoop-crime-project) | Big Data analysis of crime datasets using Apache Hadoop MapReduce | Python, Hadoop, MapReduce |
| [🎨 Drawing with LLM — PaliGemma 2](https://github.com/aritra0309/drawing-with-llm-pali-gemma-2) | Creative image generation and drawing using Google's PaliGemma 2 multimodal LLM | Python, Jupyter, Gemini API |
| [📚 ML Notebooks](https://github.com/aritra0309/ML) | A collection of machine learning experiments, models, and research notebooks | Python, Jupyter, scikit-learn |
| [🎬 YouTube Transcript Tool](https://github.com/aritra0309/youtube-transcript-tool) | Extracts and processes transcripts from YouTube videos | Python |
| [🤖 GitHub Auto Maintainer](https://github.com/aritra0309/github-auto-maintainer) | Automates GitHub repository maintenance tasks | Python |
